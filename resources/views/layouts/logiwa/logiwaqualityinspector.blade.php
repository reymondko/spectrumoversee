...
@section('title', 'Quality Inspector')
...
@section('content')
    ...
    <section id="app">
        ...
        <logiwa-quality-inspector :package_size="{{ json_encode($package_sizes) }}"></logiwa-quality-inspector>
    </section>
@stop
@section('css')
    <link rel="stylesheet" href="/css/admin_custom.css">
    <link rel="stylesheet" href="/css/jquery-ui.css">
    <link rel="stylesheet" href="/css/qualityinspector.css">
@stop
@section('js')
