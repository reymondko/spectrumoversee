                    ...
                    <td class="column-center">
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu" role="menu">
                                <li><a class="action-list-a" href="#"  data-toggle="modal" data-target="#editLocationModal" onClick="editLocation('{{$loc->id}}','{{$loc->location_type}}')">Edit</a></li>
...
<div class="modal fade" id="addLocationModal" tabindex="-1" role="dialog" aria-labelledby="addLocationModallLabel">
   <div class="modal-dialog" role="document">
      ...
      <form method="POST" action="{{ route('company_locations_save') }}">
         ...
         <div class="modal-body">
            ...
            <fieldset id="add-location-fieldset">
                <div class="form-group" >
                    <input name="companies_id" type="hidden" placeholder="Location" class="form-control input-md add-location-field-input" value="{{ $data['companies']['companies_id'] }}">
                    ...
                    <div class="col-md-8 col-md-offset-2 inventory-field-input-div">
                        <select name="location_type" id="location_type" type="text" class="form-control input-md add-location-field-input" required>
                          <option value=""></option>
                          @foreach($data['location_types'] as $location)
...
<div class="modal fade" id="editLocationModal" tabindex="-1" role="dialog" aria-labelledby="editLocationModallLabel" data-backdrop="static" data-keyboard="false">
   <div class="modal-dialog" role="document">
      <div class="modal-content">
      <form method="POST" action="{{ route('company_locations_update') }}">
         <input name="companies_id" type="hidden" placeholder="Location" class="form-control input-md add-location-field-input" value="{{ $data['companies']['companies_id'] }}">
         <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
         ...
         <div class="modal-body">
            ...
            <fieldset>
                <div class="form-group" >
                    ...
                    <div class="col-md-8 col-md-offset-2 inventory-field-input-div">
                        <select name="edit_location_type" id="edit_location_type" type="text" class="form-control input-md add-location-field-input" required>
                          <option value=""></option>
                          @foreach($data['location_types'] as $location)
                            <option value="{{$location->id}}">{{$location->description}}</option>
                          @endforeach
...
<div class="modal fade" id="deleteLocationModal" tabindex="-1" role="dialog" aria-labelledby="deleteLocationModalLabel" data-backdrop="static" data-keyboard="false">
   <div class="modal-dialog" role="document">
      <div class="modal-content">
      <form method="POST" action="{{ route('company_locations_delete') }}">
      <input name="companies_id" type="hidden" placeholder="Location" class="form-control input-md add-location-field-input" value="{{ $data['companies']['companies_id'] }}">
         <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
