                                    ...
                                    <tbody>
                                       <tr>
                                          <td class="long-text links-color" width="100%" valign="top" align="left" style="font-weight: normal; color: #3f3f3f; font-size: 13px; font-family: Arial, Helvetica, sans-serif; text-align: left; line-height: normal;">
                                             ...
                                             <p style="margin: 1em 0px; margin-top: 0px;"><strong>Error Code: </strong>{{ $data->message->getCode() }}</p>
                                             <p style="margin: 1em 0px; margin-top: 0px;"><strong>File: </strong>{{ $data->message->getFile() }}</p>
                                             <p style="margin: 1em 0px; margin-top: 0px;"><strong>Line: </strong>{{ $data->message->getLine() }}</p>
                                             <p style="margin: 1em 0px; margin-top: 0px;"><strong>Stack trace: </strong>{{ $data->message->getTraceAsString() }}</p>
                                          </td>
                                       </tr>
                                    </tbody>
                                 </table>
