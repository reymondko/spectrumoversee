<html xmlns="http://www.w3.org/1999/xhtml" xmlns:o="urn:schemas-microsoft-com:office:office">
   ...
   <body bgcolor="#3f3f3f" text="#919191" alink="#cccccc" vlink="#cccccc" style="margin: 0; padding: 0; background-color: #3f3f3f; color: #919191;">
      <center>
         <table role="presentation" class="vb-outer" width="100%" cellpadding="0" border="0" cellspacing="0" bgcolor="#bfbfbf" style="background-color: #bfbfbf;" id="ko_titleBlock_4">
            <tbody>
               <tr>
                        ...
                        <tr>
                           <td align="center" valign="top">
                              ...
                              <div style="margin: 0 auto; max-width: 570px; -mru-width: 0px;">
                                 <table role="presentation" border="0" cellpadding="0" cellspacing="0" bgcolor="#ffffff" width="570" class="vb-row" style="border-collapse: separate; width: 100%; background-color: #ffffff; mso-cellspacing: 0px; border-spacing: 0px; max-width: 570px; -mru-width: 0px;">
                                    <tbody>
                                       <tr style="
                                          background: #e8e8e8;
                                          ">
                                          <td align="center" valign="top" style="font-size: 0; padding: 0 9px;">
                                             <div style="vertical-align: top; width: 100%; max-width: 552px; -mru-width: 0px;">
                                                ...
                                                <table role="presentation" class="vb-content" border="0" cellspacing="9" cellpadding="0" style="border-collapse: separate; width: 100%; mso-cellspacing: 9px; border-spacing: 9px;" width="552">
                                                   <tbody>
                                                      <tr>
                                                         <td width="100%" valign="top" align="center" style="font-weight: normal;font-size: 22px;font-family: Arial, Helvetica, sans-serif;text-align: center;padding-bottom: 20px;"><span style="font-weight: normal;"><br><strong><em style="color: #3b4864;">SPECTRUM</em></strong><em style="color: #f39c12;font-style: normal;">OVERSEE</em></span></td>
                                                      </tr>
                                                   </tbody>
                                                </table>
                                             </div>
         ...
         <table role="presentation" class="vb-outer" width="100%" cellpadding="0" border="0" cellspacing="0" bgcolor="#bfbfbf" style="background-color: #bfbfbf;" id="ko_textBlock_6">
            <tbody>
               <tr>
                  <td class="vb-outer" align="center" valign="top" style="padding-left: 9px; padding-right: 9px; font-size: 0;">
                     <!--[if (gte mso 9)|(lte ie 8)]>
                                    ...
                                    <tbody>
                                       <tr>
                                          <td class="long-text links-color" width="100%" valign="top" align="left" style="font-weight: normal; color: #3f3f3f; font-size: 13px; font-family: Arial, Helvetica, sans-serif; text-align: left; line-height: normal;">
                                             <p style="margin: 1em 0px; margin-top: 0px;"><strong>Date: </strong>{{ date('M d, Y H:iA') }}</p>
                                             <p style="margin: 1em 0px; margin-top: 0px;"><strong>Name: </strong>{{ $data->message['name'] }}</p>
                                             <p style="margin: 1em 0px; margin-top: 0px;"><strong>Email: </strong>{{ $data->message['email'] }}</p>
                                             <p style="margin: 1em 0px; margin-top: 0px;"><strong>Phone Number: </strong>{{ $data->message['phone_number'] }}</p>
                                             <p style="margin: 1em 0px; margin-top: 0px;"><strong>Description of Issue: </strong>{{ $data->message['description'] }}</p>
                                          </td>
                                       </tr>
                                    </tbody>
                                 </table>
                     ...
                     <table role="presentation" align="center" border="0" cellspacing="0" cellpadding="0" width="570">
                        <tr>
                           <td align="center" valign="top">
                              <![endif]--><!--
                                 -->
                              <div style="margin: 0 auto;max-width: 570px;background: antiquewhite;-mru-width: 0px;">
                                 <table role="presentation" border="0" cellpadding="0" cellspacing="0" bgcolor="#ffffff" width="570" class="vb-row" style="border-collapse: separate; width: 100%; background-color: #ffffff; mso-cellspacing: 0px; border-spacing: 0px; max-width: 570px; -mru-width: 0px;">
                                    <tbody>
                                       <tr style="
                                          background: #9e9e9e3d;
                                          ...
                                          <td align="center" valign="top" style="font-size: 0; padding: 0 9px;">
                                             <div style="vertical-align: top; width: 100%; max-width: 552px; -mru-width: 0px;">
                                                ...
                                                <table role="presentation" class="vb-content" border="0" cellspacing="9" cellpadding="0" style="border-collapse: separate; width: 100%; mso-cellspacing: 9px; border-spacing: 9px;" width="552">
                                                   <tbody>
                                                      <tr>
                                                         <td width="100%" valign="top" align="center" style="font-weight: normal;  font-size: 22px; font-family: Arial, Helvetica, sans-serif; text-align: center;"><br><br></td>
                                                      </tr>
                                                   </tbody>
                                                </table>
                                             </div>
